package com.example.mobilebank2;
...
import com.example.mobilebank2.activities.LoginActivity;
import com.example.mobilebank2.activities.PaymentResultActivity;
...
import com.example.mobilebank2.qrcode.QRCodeValidator;
import com.example.mobilebank2.retrofit.Bank1Api;
...
//                .setResource(Resource.create(Attributes.of(AttributeKey.stringKey("service.name"), "MOBILEBANK2")))
//                .build();
//
...
//
//        tracer = openTelemetry.getTracer("MOBILEBANK2");
//
//        Span span = tracer.spanBuilder("MobileBank2Span").startSpan();
        ...
        Bank2Api bank2Api = retrofitBank2Service.getRetrofit().create(Bank2Api.class);
            ...
            payBtn.setOnClickListener(v -> {
                ...
                bank1Api.validateQRData(qrPaymentDto)
                        .enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                ...
                                if (response.isSuccessful()) {
                                    ...
                                    bank1Api.changeQRRequestState(qrPaymentIdDto)
